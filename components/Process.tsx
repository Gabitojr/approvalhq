      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          {steps.map((item) => (
            <div
              key={item.step}
              className="bg-[#151E32] border border-slate-800 rounded-xl p-8 relative pt-12 text-center hover:border-[#F5C518] transition-colors"
            >
              <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 w-12 h-12 bg-[#F5C518] text-[#0B1120] rounded-full flex items-center justify-center font-extrabold text-xl shadow-lg">
                {item.step}
              </div>
