      ...
      <section className="py-32 bg-[#0B1120] min-h-screen">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12 text-slate-300 leading-relaxed">
            ...
            <div>
              <p className="mb-4">
                Welcome to Fanscom Funding LLC. These Terms of Service govern your use of our website, applications, and services. By accessing or using our services, you agree to be bound by these terms. If you do not agree, please do not use our services.
              </p>
              <p className="mb-4">
            ...
            <div>
              ...
              <p className="mb-4">
                You must be at least 18 years old and represent a valid, legally registered business entity in the United States. Submitting an application does not guarantee funding. Fanscom Funding LLC evaluates business performance, revenue trajectory, and general cash flow. We may perform soft credit inquiries for identity verification and risk assessment; these do not impact your personal credit score.
              </p>

              <h3 className="text-xl font-bold text-white mb-3">2. Intellectual Property & Limitation of Liability</h3>
              <p className="mb-4">
                All content on this website is the property of Fanscom Funding LLC. To the maximum extent permitted by law, Fanscom Funding LLC shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising out of your use of our website or funding services. Our services are provided on an "as-is" and "as-available" basis.
              </p>
