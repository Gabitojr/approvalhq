      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          <h1 className="text-5xl md:text-6xl font-extrabold text-white mb-6 leading-tight">
            Streamlined Capital for <br/><span className="text-[#6366F1]">Growing Businesses</span>
          </h1>
          ...
          <button
            ...
            className="bg-[#6366F1] text-white px-10 py-4 rounded-lg hover:bg-indigo-600 hover:shadow-[0_0_20px_rgba(99,102,241,0.3)] transition font-bold text-lg inline-flex items-center gap-2"
          >
